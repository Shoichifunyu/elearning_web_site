...
if __name__ == '__main__':
    html_template = '../templates/myapp/learn_aws_contents_two_template.html'
    yaml_contents = '../templates/myapp/learn_aws_contents_two.yaml'
    html_product = '../templates/myapp/learn_aws_contents_two.html'
