...
html = open('../templates/myapp/learn_electric_circuit_contents_one_template.html')
html_read = html.read()
template = Template(html_read)
with open('../templates/myapp/learn_electric_circuit_contents_one.yaml') as file:
...
print(results)
with open("../templates/myapp/learn_electric_circuit_contents_one.html", "w") as f:
    f.write(results)
